...
--
-- Table structure for table `vote_nomination`
--

DROP TABLE IF EXISTS `vote_nomination`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vote_nomination` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `member_id` varchar(45) COLLATE utf8_bin NOT NULL,
  `description` varchar(500) COLLATE utf8_bin NOT NULL,
  `title` varchar(45) COLLATE utf8_bin NOT NULL,
  `post_path` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `vote_nomination`
--

LOCK TABLES `vote_nomination` WRITE;
/*!40000 ALTER TABLE `vote_nomination` DISABLE KEYS */;
/*!40000 ALTER TABLE `vote_nomination` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-07-11  9:40:24
