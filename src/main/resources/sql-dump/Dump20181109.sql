...
INSERT INTO `casted_votes` VALUES (1,7,'MMM111',1,NULL,'test',1,'9999-12-31 23:59:59');
...
--
-- Table structure for table `jos_ex_user_kyc_documents`
--

DROP TABLE IF EXISTS `jos_ex_user_kyc_documents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_ex_user_kyc_documents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(45) COLLATE utf8_bin NOT NULL,
  `link` varchar(500) COLLATE utf8_bin NOT NULL,
  `doc_name` varchar(100) COLLATE utf8_bin NOT NULL,
  `enabled` int(1) NOT NULL DEFAULT '1',
  `creation_date` datetime NOT NULL,
  `status` int(1) NOT NULL DEFAULT '0',
  `verified_by_user_id` int(11) DEFAULT NULL,
  `verified_on_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jos_ex_user_kyc_documents`
--

LOCK TABLES `jos_ex_user_kyc_documents` WRITE;
/*!40000 ALTER TABLE `jos_ex_user_kyc_documents` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_ex_user_kyc_documents` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `nominees` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vote_id` int(11) NOT NULL,
  `nominee_name` varchar(45) COLLATE utf8_bin NOT NULL,
  `nominee_image` varchar(5000) CHARACTER SET utf8 DEFAULT NULL,
  `nominees_description` varchar(45) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `nominees` VALUES (1,1,'Snakes and Ladders','https://image.iol.co.za/image/1/process/620x349?source=https://inm-baobab-prod-eu-west-1.s3.amazonaws.com/public/inm/media/2018/02/08/iol/554/L_F-2-2018---Credit-Christelle-Duvenhage.jpg','Lost & Found',NULL,1),(2,1,'If You Don’t You Never Will','http://primecircleband.com/wp-content/uploads/Tw1500X500-4.jpg','Prime Circle',NULL,1),(3,1,'Those Meddling Kids (TMK)','https://img.discogs.com/APh9IqF9opYhieNpOiiH5xhnvjI=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-11188534-1511526705-3103.jpeg.jpg','Shortstraw',NULL,1),(4,2,'Blitzkriek','https://i0.wp.com/vonk.co.za/wp-content/uploads/2017/10/willim.jpg','Willim Welsyn',NULL,1),(5,2,'Selfmedikasie','https://www.grammarly.com/blog/wp-content/uploads/2016/08/blog839.jpg','Fokofpolisiekar',NULL,1),(6,2,'If You Don’t You Never Will','http://primecircleband.com/wp-content/uploads/Tw1500X500-4.jpg','Prime Circle',NULL,1),(7,3,'Those Meddling Kids (TMK)','https://img.discogs.com/APh9IqF9opYhieNpOiiH5xhnvjI=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-11188534-1511526705-3103.jpeg.jpg','Shortstraw',NULL,1),(8,3,'Blitzkriek','https://i0.wp.com/vonk.co.za/wp-content/uploads/2017/10/willim.jpg','Willim Welsyn',NULL,1),(9,3,'Selfmedikasie','https://www.grammarly.com/blog/wp-content/uploads/2016/08/blog839.jpg','Fokofpolisiekar',NULL,1),(10,3,'If You Don’t You Never Will','http://primecircleband.com/wp-content/uploads/Tw1500X500-4.jpg','Prime Circle',NULL,1),(11,7,'Those Meddling Kids (TMK)','https://img.discogs.com/APh9IqF9opYhieNpOiiH5xhnvjI=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-11188534-1511526705-3103.jpeg.jpg','Shortstraw',NULL,1),(12,7,'Blitzkriek','https://i0.wp.com/vonk.co.za/wp-content/uploads/2017/10/willim.jpg','Willim Welsyn',NULL,1),(13,7,'Selfmedikasie','http://dev.exiv2.org/attachments/341/video-2012-07-05-02-29-27.mp4','Fokofpolisiekar',NULL,1);
...
INSERT INTO `user` VALUES (1,'MMM111','louis','',1,'lothmas@live.com','+2780915010',1,'1988-07-09',NULL,NULL,3,'louis','maparura',1,1,'63-19558 W 42',1,'http://www.car-brand-names.com/wp-content/uploads/2015/04/BMW-logo.png',NULL),(2,'MMM112','fifa.com','',1,'lothmas@live.com','+2780915010',1,'1988-07-09',NULL,NULL,3,'louis','maparura',1,1,'63-19558 W 42',1,'https://acnntv.com/wp-content/uploads/2017/12/world-cup-trophy_18l6eo08udnjp10sb13z6qxiok-696x392.jpg',NULL),(3,'MMM113','hair.style','',1,'lothmas@live.com','+2780915010',1,'1988-07-09',NULL,NULL,3,'louis','maparura',1,1,'63-19558 W 42',1,'https://stayglam.com/wp-content/uploads/2016/06/Short-Natural-Hairstyles-for-Black-Women2.jpg',NULL),(4,'MMM114','hair.style','',1,'lothmas@live.com','+2780915010',1,'1988-07-09',NULL,NULL,3,'louis','maparura',1,1,'63-19558 W 42',1,'https://stayglam.com/wp-content/uploads/2016/06/Short-Natural-Hairstyles-for-Black-Women2.jpg',NULL),(5,'MMM115','SA.reserve.bank','',1,'lothmas@live.com','+2780915010',1,'1988-07-09',NULL,NULL,3,'louis','maparura',1,1,'63-19558 W 42',1,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQt6ySUNTaoyZ9QzzAtMjHkELX2HBZy5eNA43cHLp4ueswbMJCqDfiYItCAJvxcxu0WGJk2UYA',NULL),(6,'MMM116','sama.awards.2018','',1,'lothmas@live.com','+2780915010',1,'1988-07-09',NULL,NULL,3,'louis','maparura',1,1,'63-19558 W 42',1,'http://samusicawards.co.za//images/sama24/sama24_logo_sqr.png',NULL);
...
CREATE TABLE `votes` (
  ...
  `vote_type` int(1) NOT NULL COMMENT '1 (order) 1 (one_select) 2(multiple_select)',
  `creation_date_time` datetime DEFAULT NULL,
  `vote_by` int(1) NOT NULL DEFAULT '0' COMMENT '1(text) 2(image) 3(video)',
  `allowed_vote_number` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
...
INSERT INTO `votes` VALUES (1,'MMM111','Pic Your Choice','2017 Best USV Of the Year','https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-mij5p9tr598drd4b5ljgunh066-20170527123550.Medi.jpeg',1,1,NULL,NULL,2,'2018-06-11 07:59:00',2,5),(2,'MMM112','Who Will Win Fifa World Cup 2018, Have your say.','2018 FIFA World Cup Russia™','https://steemitimages.com/0x0/https://cdn.steemitimages.com/DQmXo1tQGY8aPmjHJKecaNKgay7WEWR4kfniqinjy4gh1jP/fifa-world-cup-2018-russia.jpg',1,1,NULL,NULL,3,'2018-06-11 07:59:00',2,3),(3,'MMM113','Natural Hair vs. Weaves: It’s Time to End this Battle','TEAM NATURAL VS TEAM WEAVE','https://i.ytimg.com/vi/UxsgSBPbd4w/maxresdefault.jpg',1,1,NULL,NULL,1,'2018-06-11 07:59:00',2,1),(4,'MMM114','Testing Playing Video','Video Testing','http://2387227f13276d2e8940-fbe0b8d9df729a57ca0a851a69d15ebb.r55.cf1.rackcdn.com/hero_2012_demo.mp4',2,1,NULL,NULL,2,'2018-06-11 07:59:00',1,2),(5,'MMM115','Battle of the banks: how SA’s big five banks compare','SA Battle of the BANKS','https://businesstech.co.za/news/wp-content/uploads/2016/04/SA-Banks-2016-2.png',1,1,NULL,NULL,3,'2018-06-11 07:59:00',1,1),(6,'MMM114','Here’s are a few super effective triggers you can use: power, greed, competition, acceptance, status, fear, identity. Strong emotions like anger can potentially drive more downloads than positive emotions.','THE VOICE','https://videos.dailymail.co.uk/video/mol/2018/03/01/4717282354795727306/1024x576_MP4_4717282354795727306.mp4',2,1,NULL,NULL,2,'2018-06-11 07:59:00',1,1),(7,'MMM116','The South African Music Awards are returning to Sun City and you\'re invited to celebrate all things local, loud and lekker!\n\nAn evening of red-hot red carpet glamour, unmissable live acts, celebs galore and so much more','SAMA 2018','https://www.grammarly.com/blog/wp-content/uploads/2016/08/blog839.jpg',1,1,NULL,NULL,3,'2018-06-11 07:59:00',1,8);
...
-- Dump completed on 2018-11-09 16:08:16
